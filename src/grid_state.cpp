...
bool Grid_State::init(int row, int col, int tex_row, int tex_col, bool obstacle)
{
...
void Grid_State::draw(const mat3& projection, GLuint texture_id) 
{
	// Setting shaders
